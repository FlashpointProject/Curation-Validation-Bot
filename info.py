...
class Info(commands.Cog, description="General information about Flashpoint."):
    ...
    @commands.command(name="linux", brief="Linux compatibility.")
    ...
    @commands.command(name="nitrome", aliases=["nit"], brief="Nitrome information.")
    ...
    @commands.command(name="faq", brief="FAQ.")
